...
from parse_sensor_data import get_interpolated_sensor_data
from parse_sensor_data import get_interpolated_acc
...
tf.app.flags.DEFINE_string('video_index', '/data/nx-bdd-20160929/video_filtered_index_38_60_sec.txt',
